...
class Random {
	 ...
	 * 
	 * @param start
	 *            The lower number. Must be less than or equal to {@code end}.
	 * @param end
	 *            The higher number. Must be more than or equal to {@code start}.
	 *            Must not be {@code Long.MAX_VALUE}.
	 * @return A random number between {@code start} and {@code end}.
	 * @throws IllegalArgumentException
	 *             if start > end or if end is equal to Long.MAX_VALUE.
	 */
	 ...
	 * 
	 * @param items
	 *            A list of items to shuffle. Non-null.
